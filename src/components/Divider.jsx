...
const Divider = ({ title, seeAllText }) => {
  return (
    <div className="container mx-auto flex justify-between my-4 z-0">
      ...
      <div className='bg-green-900 rounded-full px-2 pt-1 flex justify-between gap-3 hover:bg-red-500 transition duration-300 ease-in-out transform cursor-pointer'>
