...
const FilterBar = () => {
  return (
    <div className="mb-2 max-[767.98px]:w-42">
      <div className="bg-green-900 pb-4 md:max-w-xs rounded-lg px-4 shadow-xl container flex flex-col ml-5 pt-4">
        <h5 className="md:text-2xl sm:text-xl font-bold">Brands</h5>
        <div className="pl-4 md:text-xl sm:text-lg font-semibold flex flex-col gap-1 mt-3">
          <p>Garnier</p>
          <p>Nestle</p>
          <p>Samsung</p>
          <p>Samsung</p>
      ...
      <div className="bg-green-900 pb-4 max-w-xs rounded px-4 shadow container flex flex-col mt-5 ml-5 pt-4 ">
        <div className="flex flex-col gap-2">
          <h5 className="md:text-2xl sm:text-xl font-bold">Price Range</h5>
          <PriceRangeInput />
        </div>
        <div></div>
      </div>
      <div className="bg-green-900 pb-2 gap-2 max-w-xs rounded px-4 shadow container flex flex-col mt-5 ml-5 pt-4 ">
        <h5 className="md:text-2xl sm:text-xl font-bold mb-2">Rating</h5>
