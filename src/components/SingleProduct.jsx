  ...
  return (
    <div className="single pb-8">
      <div className="flex gap-2 lg:container md:mx-4 lg:mx-auto md:justify-between max-md:mx-auto max-md:container max-md:flex-col px-4">
        <div className="text-black md:grid md:grid-cols-1 gap-2 md:mx-4 my-4 w-16 h-10 flex max-md:hidden">
        ...
        <div className="md:pt-6 w-full xl:w-[32rem] md:w-[26rem] md:h-[25rem]">
          <IoMdExit
            size={30}
